...
* In 2015-16 55% of inner Melbourne residents who moved moved to the outer region, compared to just 45% in 2015-16,
* In 2015-16 6% of inner Melbourne residents who moved moved to Queensland, where as the proportion had almost doubled (11%) in 2020-21.
...
* In 2015-16 37.5% of middle Melbourne residents who moved moved to the outer region, compared to just 34.5%% in 2015-16,
* THe proportion of inner residents who moved moving to the inner region (2.9% to 4.0%) Queensland (2.9% to 4.5%) and Tasmania (0.6% to 1.5%) all increased by at least 0.9%, but these changes are all relatively small.
...
* In 2015-16 30.5% of outer Melbourne residents who moved from the outer region moved to the inner region, but this increased to 35.9% in 2020-21,
* There were also increases in the proportion of outer Melbourne residents who moved who moved to Queensland (5.6% to 7.8%, Tasmania (0.8% to 2.3%))
* In 2015-16 20.%of outer Melbourne residents who moved from the outer region moved to the middle region of Melbourne, but this fell to 16.3% in 2020-21.
* There were also falls in the propotion of outer Melbourne residents who moved who moved to the rest of Victoria (23.3% to 17.2%)
...
###4.1.4 Summary of destinations of people moving FROM inner, middle and outer regions of Melbourne
...
library(gplots)
library(ggpubr)
#pivot moving_from_all 1 year ago columns to be longer, so that it can be input into GGbarstats as a data table organised by counts
# exclude final row with "Other Territories" as the numbers are very small
moving_from_total.longer <- pivot_longer(moving_from_total, cols = 2:3, names_to = "Census", values_to = "People")

library(magrittr)
moving_from_total.longer$Destination %<>% factor
moving_from_total.longer$Destination <- factor(moving_from_total.longer$Destination, levels = c(
  "Did not move",
  "Inner",
  "Middle",
  "Outer", 
