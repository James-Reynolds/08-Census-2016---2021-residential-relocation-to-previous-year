...
```{r chi_square_inner_change_1_yr, fig.fullwidth=TRUE, fig.margin = FALSE, fig.cap= "Figure 1: change residential location from one year prior to the census", fig.height=4, warning=FALSE, echo=FALSE, message = FALSE, show_col_types = FALSE} 
...
ggbarstats(
  ...
  x = Census,
  y = "Residence 1 yr ago",
  counts = People,
  label = "both",
  package = "ggsci",
  palette = "default_jama",
  title = "Place of usual residence one year before census by census, 2016 and 2021",
...
#NEXT USE GGBARSTATS and DATA ORGANISED BY COUNTS (see https://indrajeetpatil.github.io/ggstatsplot/articles/web_only/ggbarstats.html) to do the 2-way contingency statistical tests. 7
