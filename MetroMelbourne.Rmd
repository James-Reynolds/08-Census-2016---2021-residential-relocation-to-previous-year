...
#STILL TO DO, AGREGATE LGA COLUMNS into INNER, MIDDLE, OUTER, PERi-URBAN, REST OF VICTORIA, and add to df.combined_by_region.list data frames - will need to use a function with a for loop as done above in line 225. 
