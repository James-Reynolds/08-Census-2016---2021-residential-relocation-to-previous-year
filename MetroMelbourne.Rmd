...
df.combined_by_region.list <- lapply(df.combined_by_region.list, function(x){cbind(x[1],x[3], x[94:98], x[86:93], x[4:6])
 })
...
knitr::kable(
  head(X2016_combined_5yr_ago), format.args = list(big.mark = ",", scientific = FALSE), caption = '2016 census, Usual address five years ago, by region')
